...
describe('Battery Voltage Graph Test', function() {
  ...
  it('should click +, -, left, right and take screenshots', async function() {
    ...
    fs.writeFileSync('moveLeft.png', screenshotMoveLeft, 'base64');
    ...
    fs.writeFileSync('moveRight.png', screenshotMoveRight, 'base64');
  });
